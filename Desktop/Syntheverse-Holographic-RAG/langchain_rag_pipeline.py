...
Complete pipeline for scraping Zenodo, processing PDFs, and building RAG system.
...
class LangChainRAGPipeline:
    """
    Complete RAG pipeline using LangChain for Syntheverse Hydrogen Holographic research.
    """
    ...
    def run_full_pipeline(self, zenodo_urls: List[str], skip_existing: bool = True):
        ...
        """
        print("\n" + "=" * 80)
        print("Syntheverse Hydrogen Holographic RAG Pipeline (LangChain)")
        print("=" * 80)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="LangChain-based RAG pipeline for Syntheverse")
