"""
LangChain-based RAG Pipeline with Google Gemini
Complete pipeline for scraping Zenodo, processing PDFs, and building RAG system using Gemini.
...
from langchain_vector_store_gemini import LangChainVectorStoreGemini
...
class LangChainRAGPipelineGemini:
    """
    Complete RAG pipeline using LangChain with Google Gemini for Syntheverse research.
    """
    ...
    def __init__(self,
        ...
        Args:
            ...
            embedding_model: Google Gemini embedding model
    ...
    def initialize_vector_store(self):
        ...
        if self.vector_store is None:
            self.vector_store = LangChainVectorStoreGemini(
    ...
    def build_qa_chain(self, chain_type: str = "stuff"):
        """
        Build LangChain QA chain for querying with Gemini.
    ...
    def run_full_pipeline(self, zenodo_urls: List[str], skip_existing: bool = True):
        ...
        """
        print("\n" + "=" * 80)
        print("Syntheverse Hydrogen Holographic RAG Pipeline (LangChain + Gemini)")
        print("=" * 80)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="LangChain-based RAG pipeline with Gemini for Syntheverse")
    ...
    pipeline = LangChainRAGPipelineGemini(
    ...
    if args.query_only:
        ...
        print("\n" + "=" * 80)
        print("Interactive Query Interface (Gemini)")
        print("=" * 80)
